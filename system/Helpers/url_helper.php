...
if (! function_exists('base_url')) {
    ...
    function uploadData_url()   
    {
            return base_url('/upload-data');
    }
}
...
if (!function_exists('current_url')) {
    ...
    function current_url(bool $returnObject = false, ?IncomingRequest $request = null)
    {
        ...
        // Hapus 'index.php' dari URL jika ada
        $url = URI::createURIString($uri->getScheme(), $uri->getAuthority(), $uri->getPath());
        $url = str_replace('/index.php', '', $url);

        return $returnObject ? $uri : $url;
    }
}
